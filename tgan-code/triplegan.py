...
path = "/Users/dipikakhullar/Desktop/research/tgan-code/UTKFace/"
...
def generate_one_batch(path, data, batch_size, lbl = labelled_list, unlbl = unlabelled_list, tst = test_list):
    X = np.empty((batch_size, 200, 200, 3))
    ...
    return X, keras.utils.to_categorical(y, num_classes = 120)
